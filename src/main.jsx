...
class Markdown extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      editorMemory: `## Introducing Encrypto: Secure Your Word Files with Ease!.
...
`,
  ...
  editorOnChange(event) {
    this.setState({
      editorMemory: event.target.value,
    });
  }
    ...
    return (
      <>
        <div id="wrapper">
          <textarea
            id="editor"
            value={this.state.editorMemory}
            onChange={this.editorOnChange}
          ></textarea>
          <div
            id="preview"
            dangerouslySetInnerHTML={{
              __html: marked.parse(this.state.editorMemory),
            }}
          ></div>
        </div>
      </>
